    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1
            className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground leading-[0.95] text-balance opacity-0 animate-fade-up"
          ...
          <p
            className="mt-6 text-lg md:text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed opacity-0 animate-fade-up"
        ...
        <div
          className="mt-16 md:mt-24 max-w-5xl mx-auto opacity-0 animate-fade-up"
